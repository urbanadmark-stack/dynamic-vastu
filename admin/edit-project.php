...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Preserve existing files/images if not re-uploaded
    $data['project_images'] = $project_images;
    $data['rera_certificate'] = $project['rera_certificate_pdf'] ?? null;
    $data['brochure_pdf'] = $project['brochure_pdf'] ?? null;
    $data['approved_plans'] = $project['approved_plans_pdf'] ?? null;
    $data['commencement_certificate'] = $project['commencement_certificate_pdf'] ?? null;
    $data['occupation_certificate'] = $project['occupation_certificate_pdf'] ?? null;
    $data['renders_3d'] = $renders_3d;
    ...
    if (!empty($_FILES['project_images']['name'][0])) {
        ...
        if (!empty($uploaded_images)) {
            $existing_images = $project_images;
            $data['project_images'] = array_merge($existing_images, $uploaded_images);
        }
    }
    ...
    if (empty($data['project_name']) || empty($data['rera_number']) || empty($data['address']) || empty($data['city']) || empty($data['state'])) {
        ...
        try {
            if (updateProject($project['id'], $data)) {
            ...
            <form method="POST" enctype="multipart/form-data" class="admin-form">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="project_name" name="project_name" required
                                   value="<?php echo isset($_POST['project_name']) ? htmlspecialchars($_POST['project_name']) : htmlspecialchars($project['project_name'] ?? ''); ?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="project_type">Project Type <span class="required-field">*</span></label>
                            <select id="project_type" name="project_type" required>
                                <option value="residential" <?php echo ((isset($_POST['project_type']) ? $_POST['project_type'] : ($project['project_type'] ?? 'residential')) == 'residential') ? 'selected' : ''; ?>>Residential</option>
                                <option value="commercial" <?php echo ((isset($_POST['project_type']) ? $_POST['project_type'] : ($project['project_type'] ?? '')) == 'commercial') ? 'selected' : ''; ?>>Commercial</option>
                                <option value="mixed_use" <?php echo ((isset($_POST['project_type']) ? $_POST['project_type'] : ($project['project_type'] ?? '')) == 'mixed_use') ? 'selected' : ''; ?>>Mixed-Use</option>
                                <option value="plotted_development" <?php echo ((isset($_POST['project_type']) ? $_POST['project_type'] : ($project['project_type'] ?? '')) == 'plotted_development') ? 'selected' : ''; ?>>Plotted Development</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="project_status" name="project_status" required>
                                <option value="new_launch" <?php echo ((isset($_POST['project_status']) ? $_POST['project_status'] : ($project['project_status'] ?? 'new_launch')) == 'new_launch') ? 'selected' : ''; ?>>New Launch</option>
                                <option value="under_construction" <?php echo ((isset($_POST['project_status']) ? $_POST['project_status'] : ($project['project_status'] ?? '')) == 'under_construction') ? 'selected' : ''; ?>>Under Construction</option>
                                <option value="ready_to_move" <?php echo ((isset($_POST['project_status']) ? $_POST['project_status'] : ($project['project_status'] ?? '')) == 'ready_to_move') ? 'selected' : ''; ?>>Ready to Move</option>
                                <option value="oc_received" <?php echo ((isset($_POST['project_status']) ? $_POST['project_status'] : ($project['project_status'] ?? '')) == 'oc_received') ? 'selected' : ''; ?>>OC Received</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                            ...
                            <select id="rera_authority_state" name="rera_authority_state">
                                ...
                                <?php foreach ($indian_states as $state): ?>
                                    <option value="<?php echo htmlspecialchars($state); ?>" 
                                        <?php echo ((isset($_POST['rera_authority_state']) ? $_POST['rera_authority_state'] : ($project['rera_authority_state'] ?? '')) == $state) ? 'selected' : ''; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="rera_valid_till" name="rera_valid_till"
                                   value="<?php echo isset($_POST['rera_valid_till']) ? htmlspecialchars($_POST['rera_valid_till']) : htmlspecialchars($project['rera_registration_valid_till'] ?? ''); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="developer_name" name="developer_name"
                                   value="<?php echo isset($_POST['developer_name']) ? htmlspecialchars($_POST['developer_name']) : htmlspecialchars($project['developer_name'] ?? ''); ?>">
                        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="city" name="city" required
                                   value="<?php echo isset($_POST['city']) ? htmlspecialchars($_POST['city']) : htmlspecialchars($project['city'] ?? ''); ?>">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="address" name="address" rows="3" required><?php echo isset($_POST['address']) ? htmlspecialchars($_POST['address']) : htmlspecialchars($project['address'] ?? ''); ?></textarea>
                    </div>
