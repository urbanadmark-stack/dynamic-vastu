...
<body>
    ...
    <main class="property-page">
        <div class="container">
            ...
            <?php if (!empty($project['rera_registration_number'])): ?>
                <div style="margin: 0.5rem 0; padding: 0.75rem; background: #f0f9ff; border-left: 3px solid #0ea5e9; border-radius: 0.25rem;">
                    <strong>RERA Number:</strong> <?php echo htmlspecialchars($project['rera_registration_number']); ?>
            ...
            <div class="property-content-grid">
                ...
                <div class="property-sidebar">
                    ...
                    <?php if ($project['sales_contact_name'] || $project['sales_mobile_number'] || $project['sales_email_id']): ?>
                        <div class="contact-card">
                            <h3>Contact Sales</h3>
                            <?php if ($project['sales_contact_name']): ?>
                                <p class="agent-name"><?php echo htmlspecialchars($project['sales_contact_name']); ?></p>
                            <?php endif; ?>
                            <?php if ($project['sales_mobile_number']): ?>
                                <p>
                                    <a href="tel:<?php echo htmlspecialchars($project['sales_mobile_number']); ?>">
                                        <?php echo htmlspecialchars($project['sales_mobile_number']); ?>
                                    </a>
                                    <?php if ($project['whatsapp_click_to_chat'] ?? false): ?>
                                        <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', $project['sales_mobile_number']); ?>" target="_blank" style="margin-left: 0.5rem; color: #25D366;">
                            ...
                            <?php endif; ?>
                            <?php if ($project['sales_email_id']): ?>
                                <p><a href="mailto:<?php echo htmlspecialchars($project['sales_email_id']); ?>"><?php echo htmlspecialchars($project['sales_email_id']); ?></a></p>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
